...
int print_hexa(va_list types, char map_to[], char buffer[],
		int flags, char flag_ch, int width, int percision, int size);

/* Function to print non printable characters */
int print_non_printable(va_list types, char buffer[],
		int flags, int width, int percision, int size);

/* Function to print memory addsress */
...
int handle_write_char(char c, char buffer[], int flags,
		int width, int percision, int size);
int write_number(int is_positive, int ind, char buffer[],
		int flags, int width, int percision, int size);
int write_num(int ind, char bff[], int flags, int width,
		int percision, int length, char padd, char extra_c);
int write_ponter(char buffer[], int ind, int length,
